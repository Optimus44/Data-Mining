...
The Groceries dataset contains \textbf{9{,}835 transactions}, each representing one customer's
market basket.

\subsection{Number of unique items}
The dataset contains \textbf{169 unique grocery items}.
...
\textbf{63 frequent itemsets} (61 pairs and 2 triples). Table~\ref{tab:itemsets} lists the
top 10 by support.
...
\textbf{0.25}, yielding \textbf{49 rules} in total. Table~\ref{tab:rules} lists the top 12,
sorted by lift.
